...
<head>
    ...
    <title>Login</title>
    <link href="css/header.css" rel="stylesheet" id="style">
...
<div class="container">
    <!-- <div class="row"> -->
        <div class="box">
            <!--<h1 class='text-white'>LOGIN</h1>-->
              ...
              <div class="logo">
              <a>
                <img src="img/logo.png" alt="Vendor" width="180" height="100" position="center">
              </a>
              </div>
                <h4>LOGIN</h4>
                </br>
  ...
  <!--  </div> -->
    ...
    <div class="footer text-black text-center">
        <p>© 2024 FKPark | All rights reserved | Design by KAMI LA</p>
    </div>
    <!--//footer-->
</div>
</body>
