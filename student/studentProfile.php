               ...
               <div class="profile-header">
                  ...
                  <div class="profile-header-content">
                     ...
                     <div class="profile-header-info">
                        ...
                        <a href="editstudentProfile.php" class="btn btn-sm btn-info mb-2"  style="background-color: #F9D43E; border-color:#F9D43E;">Edit Profile</a>
                     </div>
                  </div>
                  <ul class="profile-header-tab nav nav-tabs">
                     <li class="nav-item"><a href="profilesection.php" target="__blank" class="nav-link_">Profile</a></li>
                  </ul>
               </div>
            </div>
         </div>
